...
-----------
	   ...
	   4. Select Update on the right-hand side of the page. Then fill out the following fields:
	    ...
	    5. Click Add Bin Location +, and two new fields will appear:
	...
	6. Now click Update to finish updating the Inventory for this Item.
		
			.. image:: C:/Users/filip/Desktop/CibosMenu/docs/setup/updateRawMatsInv.png
